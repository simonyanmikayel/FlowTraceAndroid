...
public class CodeAttribute extends Attribute
{
    ...
    public LineNumberTableAttribute lineNumTbleAttr; //added to encrease perfomance
    ...
    public int getLineNumber(int pc) {
        int lineNumper = -1;
        if(lineNumTbleAttr != null) {
            LineNumberInfo  lineNumberInfo = lineNumTbleAttr.getLineNumberInfo(pc);
