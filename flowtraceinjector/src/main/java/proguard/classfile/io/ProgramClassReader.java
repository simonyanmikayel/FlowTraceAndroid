             ...
             ElementValueVisitor
{
    ...
    public void visitLineNumberTableAttribute(Clazz clazz, Method method, CodeAttribute codeAttribute, LineNumberTableAttribute lineNumberTableAttribute)
    {
        ...
        if (codeAttribute.lineNumTbleAttr != null)
            System.err.println("ERROR: lineNumTbleAttr allready set: [" + clazz.getName() + "." + method.getName(clazz) + method.getDescriptor(clazz) + "] ");
        codeAttribute.lineNumTbleAttr = lineNumberTableAttribute;
    }
