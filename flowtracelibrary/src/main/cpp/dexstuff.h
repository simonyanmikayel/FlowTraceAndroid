...
typedef void* (*dvmCallMethodA_func)(void*,void*,void*,bool,void*,void*); //!!jvalue
...
typedef int (*dvmHashTableNumEntries_func)(void*);

typedef void (*dvmDumpClass_func)(void*,void*);

typedef int (*dvmInstanceof_func)(void*,void*);

typedef bool (*dvmDbgIsDebuggerConnected_func)();
typedef int (*dvmGetNumLoadedClasses_func)();

typedef struct dexstuff_t
{
	void *dvm_hand;
